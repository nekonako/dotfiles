...
let s:colors = {
      \ "red": get(s:overrides, "red", { "gui": "#FF8679", "cterm": "204", "cterm16": "1" }),
      \ "light_red": get(s:overrides, "light_red", { "gui": "#776DFD", "cterm": "204", "cterm16": "1" }),
      \ "dark_red": get(s:overrides, "dark_red", { "gui": "#776DFD", "cterm": "196", "cterm16": "9" }),
      \ "green": get(s:overrides, "green", { "gui": "#C3E88D", "cterm": "114", "cterm16": "2" }),
      \ "yellow": get(s:overrides, "yellow", { "gui": "#ffcb6b", "cterm": "180", "cterm16": "3" }),
      \ "dark_yellow": get(s:overrides, "dark_yellow", { "gui": "#F7B43A", "cterm": "173", "cterm16": "11" }),
      ...
      \ "vertsplit": get(s:overrides, "vertsplit", { "gui": "#c792ea", "cterm": "59", "cterm16": "15" }),
